...
import logging 
import warnings 
from skin_classification_cv.models.resnet50 import SkinResNet50
...
"""
    SkinResNet50Trainer is a class that encapsulates the training and evaluation of the SkinResNet50 model.
    It can be used to train the model, and evaluate it on a validation set, and save weights for future testing. 
"""
class SkinResNet50Trainer:
    def __init__(self, model, train_loader, test_loader, val_loader=None, criterion=None, optimizer=None, scheduler=None, device=None):
        ...
        Args:
            model (SkinResNet50): The SkinResNet50 model to train and evaluate. 
        ...
        # if not, create them 
        if not os.path.exists('./skin_classification_cv/models/resnet50/weights'):
            # Create this directory 
            os.makedirs('./skin_classification_cv/models/resnet50/weights')
            
        if not os.path.exists('./skin_classification_cv/models/resnet50/runs'):
            # Create this directory 
            os.makedirs('./skin_classification_cv/models/resnet50/runs')
    ...
    def fit(self, epochs=10, show=True, update_step=1, writer=None): 
        ...
        for epoch in range(1, epochs+1): 
            ...
            if val_stats['loss'] < best_val_loss: 
                ...
                torch.save(self.model.state_dict(), './skin_classification_cv/models/resnet50/weights/best_model.pt')
...
if __name__ == "__main__": 
    ...
    log_dir = f'skin_classification_cv/models/resnet50/runs/training-{current_time}'
    ...
    skin_resnet50 = SkinResNet50(dataset.num_classes)
    
    # Load the best model weights if they already exist
    if os.path.exists('./skin_classification_cv/models/resnet50/weights/best_model.pt'): 
        print("Found best weights @ ./skin_classification_cv/models/resnet50/weights/best_model.pt")
