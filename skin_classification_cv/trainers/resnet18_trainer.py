...
import logging 
import warnings 
from skin_classification_cv.models.resnet18 import SkinResNet18
...
"""
    SkinResNet18Trainer is a class that encapsulates the training and evaluation of the SkinResNet18 model.
    It can be used to train the model, and evaluate it on a validation set, and save weights for future testing. 
"""
class SkinResNet18Trainer:
    def __init__(self, model, train_loader, test_loader, val_loader=None, criterion=None, optimizer=None, scheduler=None, device=None):
        ...
        Args:
            model (SkinResNet18): The SkinResNet18 model to train and evaluate. 
        ...
        # if not, create them 
        if not os.path.exists('./skin_classification_cv/models/resnet18/weights'):
            # Create this directory 
            os.makedirs('./skin_classification_cv/models/resnet18/weights')
            
        if not os.path.exists('./skin_classification_cv/models/resnet18/runs'):
            # Create this directory 
            os.makedirs('./skin_classification_cv/models/resnet18/runs')
    ...
    def fit(self, epochs=10, show=True, update_step=1, writer=None): 
        ...
        for epoch in range(1, epochs+1): 
            ...
            if val_stats['loss'] < best_val_loss: 
                ...
                torch.save(self.model.state_dict(), './skin_classification_cv/models/resnet18/weights/best_model.pt')
...
if __name__ == "__main__": 
    ...
    log_dir = f'skin_classification_cv/models/resnet18/runs/training-{current_time}'
    ...
    skin_resnet18 = SkinResNet18(dataset.num_classes)
    
    # Load the best model weights if they already exist
    if os.path.exists('./skin_classification_cv/models/resnet18/weights/best_model.pt'): 
        print("Found best weights @ ./skin_classification_cv/models/resnet18/weights/best_model.pt")
        print("loading weights...")
        skin_resnet18.load_state_dict(torch.load('./skin_classification_cv/models/resnet18/weights/best_model.pt'))
    ...
    # Create the trainer 
    trainer = SkinResNet18Trainer(skin_resnet18, None, test_loader, None)
